...
import (
	...
	"github.com/appfolio/oof/internal/gitdiff"
	"github.com/appfolio/oof/internal/hcl"
	"github.com/appfolio/oof/internal/mcp"
	"github.com/appfolio/oof/internal/schema"
	"github.com/appfolio/oof/internal/usage"
	"github.com/appfolio/oof/internal/watch"
...
func renderDiffMarkdown(result *gitdiff.Result, region string) string {
	...
	sb.WriteString("_Generated by [oof](https://github.com/appfolio/oof). Estimates use on-demand pricing; actual costs may differ due to Reserved Instances, Savings Plans, and usage-based charges._\n")
